...
not fit the profile of anything that is nefarious and should therefore
be removed and so he keeps taking the honey even though he shouldn't
really be there.
It makes the feature inefficient because the antimalware
service executable is alarmed but not quarantining the honey bear.
